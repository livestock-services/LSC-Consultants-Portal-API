      ...
      CS.findOneAndUpdate(
            ...
            {new:true},(err,cd)=>{
                ...
                const newBioSubmission = new BS({
                        ...
                        siteLocation:req.body.siteLocation,
                        animalType: req.body.animalType,
                        otherSampleType: req.body.otherSampleType,
                        otherAnimalType: req.body.otherAnimalType,
                        breed: req.body.breed,
                        age: req.body.age,
                        sex: req.body.sex,
                        sampleGoodOnReceipt: req.body.sampleGoodOnReceipt,
                        ...
                        comments: req.body.comments,
                        labFindings: req.body.labFindings,
                        fecalInput: req.body.fecalInput,
                        serumInput: req.body.serumInput,
                        semenInput: req.body.semenInput,
                        liverInput: req.body.liverInput,
                        swabsInput: req.body.swabsInput,
                        skinScrapingsInput: req.body.skinScrapingsInput,
                        urineInput: req.body.urineInput,
                        earSwabsInput: req.body.earSwabsInput,
                        milkInput: req.body.milkInput,
                        impressionSmearInput: req.body.impressionSmearInput,
                        lymphnodeSmearInput: req.body.lymphnodeSmearInput,
                        brainCrushSmearInput: req.body.brainCrushSmearInput,
                        wholeBloodInput: req.body.wholeBloodInput,
                        plasmaInput: req.body.plasmaInput,
                        bloodSmearInput: req.body.bloodSmearInput,
                        biopsyInput: req.body.biopsyInput,
                        carcassInput: req.body.carcassInput,
                        abortedFetalInput: req.body.abortedFetalInput,
                        tissueOrganInput: req.body.tissueOrganInput,
                        feedSpecifyInput: req.body.feedSpecifyInput,
                        otherInput: req.body.otherInput,
                        samplesRequested: req.body.samplesRequested,
